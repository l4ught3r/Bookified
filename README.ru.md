...
| Офлайн         | [Dexie](https://dexie.org/) (IndexedDB) + dexie-react-hooks                                                                                         |
...
| FB2            | Собственный парсер (fast-xml-parser, adm-zip для `.fb2.zip`)                                                                                        |
| Ридер          | [@tanstack/react-virtual](https://tanstack.com/virtual) (длинные главы)                                                                             |
